...
impl Application {
    pub async fn build(settings: crate::settings::Settings, test_pool: Option<sqlx::postgres::PgPool>) 
...
pub async fn get_connection_pool(settings: &crate::settings::DatabaseSettings) 
...
async fn run(listener: std::net::TcpListener, db_pool: sqlx::postgres::PgPool, settings: crate::settings::Settings) 
